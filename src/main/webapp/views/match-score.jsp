...
<header>
    <div class="container bc-blue">
        <div class="table-header p-20">
            <span class="h1">Current tennis match score</span>
        </div>
    </div>
</header>
<section>
        ...
        <div class="table-general">
                ...
                <div class="table-score">
                    <div class="col-prev-sets ml-6 mr-6">
                        <div class="col-score-set">
                            ...
                            <c:if test="${currentMatch.matchScore.getGameResultsInSet(1, 0) != -1}">
                                <p class="text-score">
                                    <c:out value="${currentMatch.matchScore.getGameResultsInSet(1, 0)}"></c:out>
                                </p>
                            </c:if>
                        </div>
                        <div class="col-score-set">
                            ...
                            <c:if test="${currentMatch.matchScore.getGameResultsInSet(2, 0) != -1}">
                                <p class="text-score">
                                    <c:out value="${currentMatch.matchScore.getGameResultsInSet(2, 0)}"></c:out>
                                </p>
                            </c:if>
                        </div>
                        <div class="col-score-set">
            ...
            <c:if test="${currentMatch.matchScore.getPlayerScore(0) == currentMatch.setForWin
                ...
                <div>
                    ...
                    <div style="background-color: lightgray; margin-bottom: 0; margin-top: -10px; padding-bottom: 15px;">
