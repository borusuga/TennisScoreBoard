...
class GameRegularScoreTest {
    ...
    public void TestAdvantage() {
        ...
        assertThat(score.pointWon(0)).isEqualTo(State.ONGOING);
        assertThat(score.getPlayerScore(0)).isEqualTo(GamePoints.ADVANTAGE);

        // FORTY-FORTY again if second player won points
        assertThat(score.pointWon(1)).isEqualTo(State.ONGOING);
        assertThat(score.getPlayerScore(0)).isEqualTo(GamePoints.FORTY);
        assertThat(score.getPlayerScore(1)).isEqualTo(GamePoints.FORTY);

        // second player won two points and win game
        score.pointWon(1);
